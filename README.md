...
- a physical-item/logistics bootstrap: deterministic Wood/Stone/PrimitiveTool stacks use global stable Progressus IDs, exact fixed-point ground positions, explicit Ground/Carried location state, chunk-aware lookup, atomic reach-checked pickup/drop transitions, a hard 1,024-unit stack capacity, deterministic same-kind stack merging, and haul jobs into physical stockpile ground cells;

...
const CONTENT_NAMES: &[(&str, &str, &str, &str)] = &[
    ...
    ("item", "cart", "Тележка", "Cart"),
    ("item", "copper_ingot", "Медный слиток", "Copper ingot"),
    ("structure", "stone_wall", "Каменная стена", "Stone wall"),
    ("structure", "door", "Дверь", "Door"),
    ("structure", "bed", "Кровать", "Bed"),
    ("workstation", "workbench", "Верстак", "Workbench"),
    ("workstation", "furnace", "Печь", "Furnace"),
    (
        "recipe",
        "primitive_tool",
        "Примитивный инструмент",
...
impl Locale {
    pub(crate) const fn tr(self, key: TextKey) -> &'static str {
        match (self.language, key) {
            ...
            (Language::Ru, TextKey::RemoveWorkstation) => "Убрать производство",
            ...
            (Language::Ru, TextKey::Rest) => "Отдых",
            (Language::Ru, TextKey::LastSleepShelter) => "Прошлый сон",
            (Language::Ru, TextKey::Sheltered) => "под укрытием",
            (Language::Ru, TextKey::Unsheltered) => "без укрытия",
            ...
            (Language::En, TextKey::ExcavateRock) => "Excavate rock",
            (Language::En, TextKey::StoneWall) => "Stone wall",
            (Language::En, TextKey::Door) => "Door",
            (Language::En, TextKey::Bed) => "Bed",
            (Language::En, TextKey::Workbench) => "Workbench",
            (Language::En, TextKey::Furnace) => "Furnace",
            ...
            (Language::En, TextKey::RemoveWorkstation) => "Remove workstation",
            ...
            (Language::En, TextKey::Rest) => "Rest",
            (Language::En, TextKey::LastSleepShelter) => "Last sleep",
            (Language::En, TextKey::Sheltered) => "sheltered",
            (Language::En, TextKey::Unsheltered) => "unsheltered",

...
- hungry characters with no available Berries may autonomously designate a reachable explored bush for ordinary Harvest inside the bounded bootstrap foraging radius; manual Harvest remains unrestricted;
...
- with the bootstrap Berries removed, four starter bushes keep all five characters above zero satiety for 10,000 ticks without autonomous long-range scouting;
